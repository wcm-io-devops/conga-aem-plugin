package io.wcm.devops.conga.plugins.aem.it.aemsample.config;
...
public enum AppTemplate implements TemplatePathInfo {
   ...
   * Structure element
   */
  ADMIN_STRUCTURE_ELEMENT("/apps/wcmio-aem-archetype/core/templates/admin/structureElement"),

  /**
   * Redirect
   */
  ADMIN_REDIRECT("/apps/wcmio-aem-archetype/core/templates/admin/redirect"),

  /**
   * Content page
   */
  CONTENTPAGE("/conf/wcmio-aem-archetype/settings/wcm/templates/contentpage"),

  /**
   * Home page
   */
  HOMEPAGE("/conf/wcmio-aem-archetype/settings/wcm/templates/homepage");
