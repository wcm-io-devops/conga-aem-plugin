...
public final class ContentPackageOptions {
  ...
  /**
   * List of additional binary files to be included in content package. Mandatory properties for each file:
   * <code>url</code> (source) and <code>path</code> (target).
   * If the file that is included was generated by CONGA and should be deleted after the inclusion you can additionally
   * specify <code>delete: true</code>.
   */
