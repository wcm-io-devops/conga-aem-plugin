...
public class ContentPackageUtilTest {

  @Test
  public void testGetPackagePropertiesFile() throws Exception {
    File packageFile = new File("src/test/resources/package/example.zip");
    Map<String, Object> props = ContentPackageUtil.getPackageProperties(packageFile);
